...
# define the colors used by ls command
...
# run $@ per 5s until success
retry_per_5s() { while true; do $@ && return; echo retrying; sleep 5; done }
run_forever() { while true; do $@; sleep 5; done }
